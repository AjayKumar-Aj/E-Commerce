...
export default defineMessages({
  header: {
    id: `${scope}.header`,
    defaultMessage: 'FeatSDDSSDures',
  },
  scaffoldingHeader: {
    id: `${scope}.scaffolding.header`,
    defaultMessage: 'hiiii',
  },
  scaffoldingMessage: {
    id: `${scope}.scaffolding.message`,
    defaultMessage: `DSDD the creation of components, containers, routes, selectors
  ...
  networkMessage: {
    ...
    defaultMessage: `
      The next frontier in performant web SDD: availability without a
